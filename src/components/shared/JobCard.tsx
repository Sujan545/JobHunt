...
export default function JobCard({ job }: Props) {
  return (
    <div className="group relative rounded-2xl border bg-white p-5 shadow-sm transition hover:shadow-lg">
      
      {/* Company Logo */}
      <div className="flex items-center gap-4">
        <div className="relative h-12 w-12 overflow-hidden rounded-xl border bg-gray-50">
          <Image
            src={job.companyLogo}
            alt={job.companyName}
            fill
